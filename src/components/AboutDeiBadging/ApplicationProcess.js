  ...
  return (
    <div className="application_process">
      ...
      <div>
        ...
        <p>
          Before applying for a CHAOSS Project DEI Badge, maintainers or project admins are
      ...
      <div>
        ...
        <p>
          ...
          maintainers can proceed to <a href="https://badging.chaoss.community/badge">apply here</a>. The applicant must be an administrator
      ...
      <div>
        ...
        <p>
          Projects that meet the established criteria will receive the
          CHAOSS DEI Project Badge, which can be prominently displayed on the
      ...
      <div>
        ...
        <p>
          Once the badging process is completed, you can re-apply for a project badge -- we recommend after about a year. We will
          also be developing CHAOSS Project Badges for Silver, Gold, and Platnium levels in the future that include new CHAOSS metrics. 
        </p>
      </div>
    </div>
  );
