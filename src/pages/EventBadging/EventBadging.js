            ...
            <div className='desc-group'>
              ...
              >
                <div className='info'>
                  ...
                  <p>
                    ...
                    through which open source event organizers earn badges that
                    acknowledge their ongoing commitment to improving and
              ...
              >
                <div className='info'>
                  ...
                  <div className='about-parag'>
                    ...
                    <p>
                      First, an event organizer will submit a badge application
                      and answer questions that are based on CHAOSS DEI Metrics.
                      Once an event organizer applies for the CHAOSS DEI Event
                      badge, the application goes through a human review, where
                      two reviewers examine the event’s application, making sure
                      it is in line with either our in-person or virtual event
                      review checklist. This is a transparent and open process,
                      as all reviews and feedback are done publicly through a
                      repository on GitHub. Once the review is concluded, we
                      award badges according to the performance of the review.
                      These badges come in four different levels. When an event
                      is awarded the DEI Badge, it tells potential speakers,
                      sponsors, and attendees how much the event organizers are
                      concerned about making their events diverse and inclusive
                      to everyone.
                    </p>
                  </div>
                  ...
                  <div className='about-parag'>
                    ...
                    <p>
                      ...
                      CHAOSS DEI Event Badging Repository. In order to submit an
                      application for your event/conference, review the
                      following documents:
                      ...
                      event/conference to be eligible for a CHAOSS badging
                      process
              ...
              >
                <div className='info'>
                  <h1>How to apply</h1>
                  <p>
                    To submit an application for your event/conference, you will
                    need to have a GitHub account, as well as meet the following
                    requirements:
                  </p>
                  <div className='des-bullets'>
                    ...
                    <ul className='bullet-list'>
                      ...
                      <li>
                        You should be an organizer of the event you are applying
                        for.
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className='des-bullets'>
                    ...
                    <ul className='bullet-list num'>
                      ...
                      <li>
                        ...
                        provide event information according to the metrics your
                        event is committed to.
                      </li>
                      <li>
              ...
              <div className={showAbout == 'badger' ? 'showDesc' : 'hideDesc'}>
                <div className='info'>
                  ...
                  <p>
                    ...
                    inclusive and welcoming, becoming a Badger is a great way to
                    do that! Badgers review incoming event badge applications
                    and interact with the event organizers through GitHub. You
                    do not need to have a deep knowledge of CHAOSS or the DEI
                    metrics used in the application, so this is a perfect
                    opportunity for those new to the community to begin
